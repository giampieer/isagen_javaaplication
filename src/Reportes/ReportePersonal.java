...
public class ReportePersonal {
  ...
  //cn=DriverManager.getConnection("jdbc:mysql://mysql22353-mariscal2424.j.facilcloud.com/relacion","root","QKElak40188");
         cn=DriverManager.getConnection("jdbc:mysql://localhost/relacion1","root","");
            ...
            rs=st.executeQuery("select * from personal where numproy='"+ventanaproy.num+"'");
            ...
            Document documento=new Document();
                PdfWriter.getInstance(documento, new FileOutputStream(ventanaimp.ruta+".reportepersonal.pdf"));
                documento.open();
                ...
                par2.add(new Phrase("PERSONAL  DEL PROYECTO ",descripcion));
                ...
                par2.add(new Phrase(Chunk.NEWLINE));
                 ...
                 PdfPCell celda5=new PdfPCell(new Paragraph("HORAS",FontFactory.getFont("Arial",12,Font.BOLD,BaseColor.BLACK )));
                 PdfPCell celda6=new PdfPCell(new Paragraph("DIAS",FontFactory.getFont("Arial",12,Font.BOLD,BaseColor.BLACK )));
                 PdfPCell celda7=new PdfPCell(new Paragraph("ID",FontFactory.getFont("Arial",12,Font.BOLD,BaseColor.BLACK )));
                 PdfPCell celda8=new PdfPCell(new Paragraph("PASS",FontFactory.getFont("Arial",12,Font.BOLD,BaseColor.BLACK )));
                 PdfPCell celda9=new PdfPCell(new Paragraph("NUM. PROYECTO",FontFactory.getFont("Arial",12,Font.BOLD,BaseColor.BLACK )));
          ...
          tabla.addCell(rs.getString(8));               
            ...
            documento.close();
              //abrir automaticamente pdf
                 //Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler " + ""+ventanaimp.ruta+".reportepersonal.pdf");
            
              String rut=new String(ventanaimp.ruta+".reportepersonal.pdf");
