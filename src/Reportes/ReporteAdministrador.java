...
public class ReporteAdministrador {
  ...
  //cn=DriverManager.getConnection("jdbc:mysql://mysql22353-mariscal2424.j.facilcloud.com/relacion","root","QKElak40188");
         cn=DriverManager.getConnection("jdbc:mysql://localhost/relacion1","root","");
            ...
            rs=st.executeQuery("select * from jefe where codjefe='"+ventanaproy.num+"'");
            ...
            try {
             ...
             Document documento=new Document();
                PdfWriter.getInstance(documento, new FileOutputStream(ventanaimp.ruta+".reporteadmin.pdf"));
                documento.open();
        ...
        tabla.addCell(rs.getString(7));          
            ...
            documento.close();
              //abrir automaticamente pdf
                // Runtime.getRuntime().exec("rundll32 url.dll,FileProtocolHandler " + ""+ventanaimp.ruta+".reporteadmin.pdf");
                    String rut=new String(ventanaimp.ruta+".reporteadmin.pdf");
